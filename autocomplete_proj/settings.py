...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "static_data"),]

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "autocomplete_proj","static_cdn", "media_root")

STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "autocomplete_proj","static_cdn","static_root")